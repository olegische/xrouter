# Документация Rerank API

**Введение**: Документация Rerank API

## Интеграция с Dify
Выберите Jina в качестве поставщика модели и заполните информацию о модели в соответствии с требованиями для интеграции с Dify.
